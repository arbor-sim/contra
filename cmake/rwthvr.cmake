...
macro(RWTHVR_ADD_LIBRARY)
  ...
  add_test_cpplint(NAME "${RWTHVR_ADD_LIBRARY__NAME}-tests--cpplint"
    ${RWTHVR_ADD_LIBRARY__SOURCES}
    ${RWTHVR_ADD_LIBRARY__HEADERS}
  )
  
  add_test_cppcheck(NAME "${RWTHVR_ADD_LIBRARY__NAME}-tests--cppcheck"
    ${RWTHVR_ADD_LIBRARY__SOURCES}
    ${RWTHVR_ADD_LIBRARY__HEADERS}
  )
...
macro(RWTHVR_ADD_EXECUTABLE)
  ...
  add_test_cpplint(NAME "${RWTHVR_ADD_EXECUTABLE__NAME}-tests--cpplint"
    ${RWTHVR_ADD_EXECUTABLE__SOURCES}
    ${RWTHVR_ADD_EXECUTABLE__HEADERS}
  )
  
  add_test_cppcheck(NAME "${RWTHVR_ADD_EXECUTABLE__NAME}-tests--cppcheck"
    ${RWTHVR_ADD_EXECUTABLE__SOURCES}
    ${RWTHVR_ADD_EXECUTABLE__HEADERS}
  )

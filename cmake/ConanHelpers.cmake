...
if(USE_CONAN AND CONAN_BUILD_INFO)
  ...
  set(CONAN_HELPER_LIBS)
  foreach(LIB in ${CONAN_LIBS})
    unset(LIB_FILE CACHE)
    find_library(LIB_FILE NAME ${LIB} HINTS ${CONAN_LIB_DIRS})
    message("LIB ${LIB}: ${LIB_FILE}")
    if (LIB_FILE)
      set(CONAN_HELPER_LIBS ${CONAN_HELPER_LIBS} ${LIB_FILE})
    endif()
  endforeach(LIB in ${CONAN_LIBS})
  message("CONAN_HELPER_LIBS ${CONAN_HELPER_LIBS}")
endif()
...
macro(CONAN_OR_FIND_PACKAGE package)
  ...
  if(USE_CONAN AND USE_CONAN_${package})
    set(CONAN_OR_CMAKE_${package_underscored} ${CONAN_HELPER_LIBS})
  else()
